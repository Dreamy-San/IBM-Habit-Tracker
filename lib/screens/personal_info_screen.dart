      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Age: ${_age.round()}',
              style: TextStyle(color: const Color(0xFF8772FF), fontSize: 18),
            ),
            Slider(
              value: _age,
              min: 21,
              max: 100,
              divisions: 79,
              activeColor: const Color.fromARGB(255, 157, 140, 252),
              inactiveColor: const Color.fromARGB(255, 201, 192, 255),
              onChanged: (value) {
                setState(() {
                  _age = value;
                });
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(icon, color: const Color(0xFF8772FF)),
          labelText: label,

...
class _HabitTrackerScreenState extends State<HabitTrackerScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    print('Loaded SharedPreferences:');
  ...
  Color _getHabitColor(String habit, Map<String, String> habitsMap) {
    ...
    if (colorHex != null) {
      try {
        ...
        print('Error parsing color for $habit: $e'); // This is the print statement
      }
    }
  ...
  Widget _buildHabitCard(String title, Color color,
    ...
    return Card(
      ...
      item: {'title': 'Read A Book', 'description': 'Reading is a great habit!'}, // Pass the habit details
    ), // Pass the habit title
            ),
          );
        },  
        ),
